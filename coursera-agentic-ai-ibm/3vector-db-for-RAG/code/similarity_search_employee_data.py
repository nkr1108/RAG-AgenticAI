...
# STEP3 - CREATING AN INSTANCE OF CHROMA CLIENT
# Creating an instance of ChromaClient to establish a connection with the Chroma database
client = chromadb.Client()

# STEP4 - Defining a name for the collection where data will be stored or accessed
...
def main():
    try:
        ...
        # STEP6 - GET THE INPUT DATA - EMPLOYEE DATA
        ...
        # STEP7 - CREATE COMPREHENSIVE TEXT DOCUMENTS FOR EACH EMPLOYEE
        ...
        # STEP8 - ADDING DATA TO THE COLLECTION IN THE CHROMA DATABASE
        ...
        # STEP10 - PERFORM ADVANCED SEARCHES WITHIN THE COLLECTION
